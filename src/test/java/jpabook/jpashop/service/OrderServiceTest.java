...
public class OrderServiceTest {
    ...
    public void 상품주문() {
        ...
        Book book = createBook("Younghan Kim", 10000, 10);
        ...
        assertEquals(1,getOrder.getOrderItems().size(),"주문한 상품 종류의 수가 정확해야한다.");
        assertEquals(10000*orderCount,getOrder.getTotalPrice(),"주문한 가격은 가격 * 수량이다.");
        assertEquals(7,book.getStockQuantity(),"주문한 수량만큼 재고가 줄어야한다.");
    }
    ...
    public void 주문취소() throws Exception {
        ...
        // then
        Order getOrder = orderRepository.findOne(orderId);
        Assertions.assertEquals(10,book.getStockQuantity(),"주문이 취소된 상품은 그 만큼 재고가 증가해야한다.");
    ...
    private Long createMember() {
        ...
        memberA.setName("Kim");
        memberA.setAddress(new Address("Seoul","Gangnam Street","B0147"));
